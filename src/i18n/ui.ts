...
export const ui = {
  en: {
    ...
    'kicker.projects': 'Fullstack · Game Dev · Game AI Research',
    'kicker.games': 'Unity · WebGL · playable in the browser',
    'kicker.articles': 'Papers and notes',
    'kicker.teaching': 'Senac RS · UC2 · Databases',
    'kicker.cv': 'Porto Alegre, Brazil · UTC−3 · open to remote',
  ...
  pt: {
    ...
    'kicker.projects': 'Fullstack · Game Dev · Pesquisa em IA para Jogos',
    'kicker.games': 'Unity · WebGL · jogável no navegador',
    'kicker.articles': 'Artigos e notas',
    'kicker.teaching': 'Senac RS · UC2 · Banco de Dados',
    'kicker.cv': 'Porto Alegre · UTC−3 · aberto a remoto',
